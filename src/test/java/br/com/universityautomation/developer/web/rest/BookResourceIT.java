...
import br.com.universityautomation.developer.repository.BookRepository;
...
class BookResourceIT {
    ...
    private static final Double DEFAULT_ISBN = 1D;
    private static final Double UPDATED_ISBN = 2D;
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().autor(DEFAULT_AUTOR).isbn(DEFAULT_ISBN).editora(DEFAULT_EDITORA).edicao(DEFAULT_EDICAO);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().autor(UPDATED_AUTOR).isbn(UPDATED_ISBN).editora(UPDATED_EDITORA).edicao(UPDATED_EDICAO);
        return book;
    }
    ...
    void createBook() throws Exception {
        ...
        assertThat(testBook.getAutor()).isEqualTo(DEFAULT_AUTOR);
        assertThat(testBook.getIsbn()).isEqualTo(DEFAULT_ISBN);
        assertThat(testBook.getEditora()).isEqualTo(DEFAULT_EDITORA);
        assertThat(testBook.getEdicao()).isEqualTo(DEFAULT_EDICAO);
    }
    ...
    void getAllBooks() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.[*].isbn").value(hasItem(DEFAULT_ISBN.doubleValue())))
    ...
    void getBook() throws Exception {
        ...
        restBookMockMvc
            ...
            .andExpect(jsonPath("$.isbn").value(DEFAULT_ISBN.doubleValue()))
    ...
    void putExistingBook() throws Exception {
        ...
        updatedBook.autor(UPDATED_AUTOR).isbn(UPDATED_ISBN).editora(UPDATED_EDITORA).edicao(UPDATED_EDICAO);
        ...
        Book testBook = bookList.get(bookList.size() - 1);
        assertThat(testBook.getAutor()).isEqualTo(UPDATED_AUTOR);
        assertThat(testBook.getIsbn()).isEqualTo(UPDATED_ISBN);
        assertThat(testBook.getEditora()).isEqualTo(UPDATED_EDITORA);
        assertThat(testBook.getEdicao()).isEqualTo(UPDATED_EDICAO);
    }
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.autor(UPDATED_AUTOR).isbn(UPDATED_ISBN).editora(UPDATED_EDITORA).edicao(UPDATED_EDICAO);
