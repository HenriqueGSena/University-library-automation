...
import br.com.universityautomation.developer.domain.Student;
import br.com.universityautomation.developer.repository.StudentRepository;
...
class StudentResourceIT {
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student().curso(DEFAULT_CURSO);
        return student;
    }
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        Student student = new Student().curso(UPDATED_CURSO);
        return student;
    }
    ...
    void createStudent() throws Exception {
        ...
        assertThat(testStudent.getCurso()).isEqualTo(DEFAULT_CURSO);
    }
    ...
    void putExistingStudent() throws Exception {
        ...
        updatedStudent.curso(UPDATED_CURSO);
        ...
        Student testStudent = studentList.get(studentList.size() - 1);
        assertThat(testStudent.getCurso()).isEqualTo(UPDATED_CURSO);
    }
    ...
    void fullUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.curso(UPDATED_CURSO);
