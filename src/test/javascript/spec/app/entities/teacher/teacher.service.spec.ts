...
describe('Service Tests', () => {
  describe('Teacher Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Teacher(123, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not update a Teacher', async () => {
      ...
      it('should partial update a Teacher', async () => {
      ...
      it('should not partial update a Teacher', async () => {
      ...
      it('should not return a list of Teacher', async () => {
        axiosStub.get.rejects(error);
