...
/**
 * REST controller for managing {@link br.com.universityautomation.developer.domain.Teacher}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class TeacherResource {
    ...
    public ResponseEntity<Teacher> partialUpdateTeacher(
        ...
        Optional<Teacher> result = teacherRepository
            ...
            .map(existingTeacher -> {
                if (teacher.getMateria() != null) {
                    existingTeacher.setMateria(teacher.getMateria());
                }
