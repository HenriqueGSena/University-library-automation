...
export default class EmprestimoService {
  ...
  public create(entity: IEmprestimo): Promise<IEmprestimo> {
    return new Promise<IEmprestimo>((resolve, reject) => {
      axios
  ...
  public update(entity: IEmprestimo): Promise<IEmprestimo> {
    return new Promise<IEmprestimo>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: IEmprestimo): Promise<IEmprestimo> {
    return new Promise<IEmprestimo>((resolve, reject) => {
      axios
